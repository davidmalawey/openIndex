...
[:fa-solid fa-eye: View Documentation](https://bit.ly/openboxproject ':class=button') [:a-brands fa-github:Download](https://github.com/davidmalawey/openAir ':class=button') 
